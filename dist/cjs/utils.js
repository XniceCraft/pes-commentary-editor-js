...
exports.isBinaryValid = isBinaryValid;
exports.decimalToBytes = decimalToBytes;
exports.sortAndCountPlayers = sortAndCountPlayers;
exports.formatTo6String = formatTo6String;
 ...
 */
function sortAndCountPlayers(players) {
    const sorted = [...players].sort((a, b) => a.playerName.localeCompare(b.playerName, "en", { sensitivity: "base" }));
    const counts = {};
    for (let i = 0; i < 26; i++) {
