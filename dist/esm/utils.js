 ...
 */
export function cleanString(buffer) {
 ...
 * }
 */
export function isBinaryValid(buffer) {
    return (buffer[0] === 83 &&
        buffer[1] === 69 &&
        buffer[2] === 80 &&
        buffer[3] === 68 &&
 ...
 */
export function decimalToBytes(num) {
 ...
 */
export function sortAndCountPlayers(players) {
 ...
 */
export function formatTo6String(num) {
